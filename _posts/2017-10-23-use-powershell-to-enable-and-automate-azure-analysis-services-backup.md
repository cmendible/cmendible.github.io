---
title: Use Powershell to Enable and Automate Azure Analysis Backup
date: 2017-10-23T20:53:16+00:00
...
Enable-AzureRmAnalysisServicesBackup is a small powershell script that uses the the Set-AzureRmResource cmdlet to enable backup location to an Azure Analysis Service instance.</p> 
...
Get the code <a href="https://github.com/cmendible/azure.powershell.samples/tree/master/Enable-AzureRmAnalysisServicesBackup">here</a> or download the file from the <a href="https://gallery.technet.microsoft.com/Enable-AzureRmAnalysisServi-254a889c" rel="noopener" target="_blank">Technet Gallery</a>.
...
Get the code <a href="https://github.com/cmendible/azure.powershell.samples/tree/master/Backup-AnalysisServices">here</a> or download the file from the <a href="https://gallery.technet.microsoft.com/Azure-Analysis-Backup-a06df3ad" rel="noopener" target="_blank">Technet Gallery</a>. 
